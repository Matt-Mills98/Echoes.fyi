...
export default function StickyHeadTable(props) {
    ...
    const { id, totalParams, auto, setRows, rows, initPlayingArr, playingArr, setIsPlayingArr, setIndex, setType, setTrackID, trackID } = props;
                                            ...
                                            {visibleRows?.map((item, index) => {
                                                ...
                                                return (
                                                    <TableRow sx={{
                                                        ...
                                                        <TableCell align={'right'} sx={{ borderBottom: 'none', width: '5%' }} >
                                                            <IconButton sx={{ color: '#999999' }} onClick={(event) => { setPlaying(false); openMenu(event, item, actIndex); }}>
